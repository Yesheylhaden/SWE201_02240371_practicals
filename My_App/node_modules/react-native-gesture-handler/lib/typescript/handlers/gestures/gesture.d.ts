import { HitSlop, CommonGestureConfig, GestureTouchEvent, GestureStateChangeEvent, GestureUpdateEvent, ActiveCursor, MouseButton } from 'react-native-gesture-handler/src/handlers/gestureHandlerCommon';
import { GestureStateManagerType } from 'react-native-gesture-handler/src/handlers/gestures/gestureStateManager';
import type { FlingGestureHandlerEventPayload, ForceTouchGestureHandlerEventPayload, LongPressGestureHandlerEventPayload, PanGestureHandlerEventPayload, PinchGestureHandlerEventPayload, RotationGestureHandlerEventPayload, TapGestureHandlerEventPayload, NativeViewGestureHandlerPayload, HoverGestureHandlerEventPayload } from 'react-native-gesture-handler/src/handlers/GestureHandlerEventPayload';
